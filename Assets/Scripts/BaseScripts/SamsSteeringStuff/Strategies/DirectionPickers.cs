...
public class BasicDirectionPicker : IDecideDirection
{
    ...
    public Vector3 GetDirection(float[] contextMap, Vector3 lastVector)
    {
        ...
        Vector3 direction = Vector3.up * maxValue;
        ...
        return Quaternion.Euler(0, 0, resolutionAngle * maxIndex) * direction;
    }
}
...
public class DirectionSimpleSmoothing : IDecideDirection
{
    ...
    public Vector3 GetDirection (float[] contextMap, Vector3 lastVector)
    {
        ...
        Vector3 nextVector = Quaternion.Euler(0, 0, resolutionAngle * maxIndex) * direction;
